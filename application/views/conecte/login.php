...
<body>
    <div class="main-login">
        <div class="left-login">
            ...
            <img src="<?php echo base_url() ?>assets/img/forms-animate.svg" class="left-login-imagec" alt="Organize 5.0">
        </div>
                            ...
                            <div class="card card-cad">
                                <div class="content">
                                    <div id="newlog">
                                        ...
                                        <div class="title01">
                                            <img src="<?php echo base_url() ?>assets/img/logo-Organize-branco.png">
                                        </div>
                                    </div>
                                    ...
                                    <div class="links-uteis"><a href="https://organizebr.com.br/">
                                            <p><?= date('Y'); ?> &copy; <?= $this->config->item('app_name') ?></p>
                                        </a></div>
                                </div>
                            </div>
                        </div>
