...
<?= '<img src="'.base_url().'assets/img/logo-Organize-branco.png">'; ?>
								...
								<form action="index.html" method="post">
									...
									<div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<div class="modal-header">
											<h4 id="myModalLabel" class="center">Organize - Simplificando o Sucesso do Seu Negócio</h4>
										</div>
			...
			<div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-header">
					<h4 id="myModalLabel">Organize</h4>
				</div>
				<div class="modal-body">
					<h5 style="text-align: center" id="message">Os dados de acesso estão incorretos, por favor tente novamente!</h5>
				</div>
						...
						submitHandler: function(form) {
							...
							$.ajax({
								...
								success: function(data) {
									if(data.result == true) {
										window.location.href = "<?= site_url('Organize'); ?>";
									}
									else {
